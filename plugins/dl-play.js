...
const handler = async (m, {
    ...
    const infoText = `✦ ──『 *3OMAR BOT* 』── ⚝ \n\n [ 🇲🇦 *_قم بالرد برقم الأغنية التي تريد_*]. \n\n` ;
...
async function searchAndDownloadMusic(query) {
    try {
        ...
        if (!videos.length) return "اعتذر. البحث غير موجود...";
